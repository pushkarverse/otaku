...
const CONFIG = {
    ...
    // =================== PURPLE (dung hợp) ===================
    PURPLE: {
        coreRatio: 0.9,         // More concentrated core
        coreRadius: 8,          // Smaller, denser orb like the image
        coreColor: { r: 1.2, g: 0.4, b: 3.0 }, // Much more vibrant purple/blue highlights
        coreSize: 1.2,

        outerSpread: 40,
        outerColor: { r: 0.8, g: 0.2, b: 1.0 },
        outerSize: 0.8,

        rotationSpeedA: 0.25,   // Faster swirling
        rotationSpeedB: -0.22,  // Faster counter-rotation
        rotationY: 0.05,
    ...
    // =================== GESTURE DETECTION ===================
    DETECTION: {
        crossedFingerThreshold: 0.035, // Strict threshold for the Gojo crossed-finger sign
        snapCooldownFrames: 30,         // Frame cooldown sau mỗi lần bắn (chỉ tay)
        chargeFrames: 10,               // Faster charging (0.3s) for smoother firing
    ...
    // =================== BLACK FLASH ===================
    BLACK_FLASH: {
        boltCount: 15,          // Number of lightning bolts
        boltSegments: 8,        // Jagged segments per bolt
        boltSpread: 15,         // Max distance from fist
        coreColor: { r: 0, g: 0, b: 0 },      // Black core
        glowColor: { r: 4.0, g: 0, b: 0.1 },  // Bright Red glow
        boltSize: 2.0,
        duration: 40,           // Longer duration for the video-based effect
        bloom: 8.0,
        shake: 2.0,
    },
